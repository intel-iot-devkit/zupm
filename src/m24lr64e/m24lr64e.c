...
upm_sensor_descriptor_t upm_m24lr64e_get_descriptor(void* dev){
...
void* upm_m24lr64e_get_ft(upm_sensor_t sensor_type){
	if(sensor_type == UPM_SENSOR){
		...
		ft->upm_sensor_init_name = upm_m24lr64e_init_name;
		ft->upm_sensor_close = upm_m24lr64e_close;
		ft->upm_sensor_read = upm_m24lr64e_read;
		ft->upm_sensor_write = upm_m24lr64e_write;
		return ft;
	}
	return NULL;
}

void* upm_m24lr64e_init_name(int num, ...){
	upm_m24lr64e dev = (upm_m24lr64e) upm_malloc(UPM_M24LR64E_MEM_MAP, sizeof(struct _upm_m24lr64e));
...
upm_result_t upm_m24lr64e_write(void* dev, void* value, int len){
	upm_m24lr64e device = (upm_m24lr64e) dev;
...
upm_result_t upm_m24lr64e_read(void* dev, void* data, int* len){
	upm_m24lr64e device = (upm_m24lr64e) dev;
